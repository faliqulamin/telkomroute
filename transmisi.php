                        ...
                        <div class="col-md-12">
							<div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Transmition data</h3>
                                    ...
                                    <table id="tblTransmisi"  class="table table-striped" cellspacing="0" width="100%">
										<thead>
											<tr>
												...
												<th><p style="text-align:center;">Transmisi</p></th>
						...
						<div class="block">
                                <form class="form-horizontal" role="form">                                    
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Transmisi Name</label>
                                        <div class="col-md-7">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
											<select class="form-control select" data-live-search="true" id="slcVend">
											</select>
										</div>
                                    </div>                                
                                </form>
